...
class KeyboardShortcutTrigger : public KeyboardTrigger
{
public:
    KeyboardShortcutTrigger(KeyboardShortcut shortcut);
    KeyboardShortcutTrigger(KeyboardShortcut shortcut, std::unique_ptr<TimeTriggerCore> core);

    const KeyboardShortcut &shortcut() const { return m_shortcut; }
