...
private slots:
    ...
    void mouse_triggerHandlerSetting_motionTimeout__addsDeprecatedFeatureConfigIssue()
    {
        ...
        INPUTACTIONS_VERIFY_ADDS_CONFIG_ISSUE_SAVE(node->as<std::vector<InputDeviceRule>>(), DeprecatedFeatureConfigIssue, 2, 30, issue);
    ...
    void mouse_triggerHandlerSetting_pressTimeout__addsDeprecatedFeatureConfigIssue()
    {
        ...
        INPUTACTIONS_VERIFY_ADDS_CONFIG_ISSUE_SAVE(node->as<std::vector<InputDeviceRule>>(), DeprecatedFeatureConfigIssue, 2, 29, issue);
        QCOMPARE(issue->feature(), DeprecatedFeature::TriggerHandlerSettings);
    }
    ...
    void mouse_triggerHandlerSetting_unblockButtonsOnTimeout__addsDeprecatedFeatureConfigIssue()
    {
        ...
        INPUTACTIONS_VERIFY_ADDS_CONFIG_ISSUE_SAVE(node->as<std::vector<InputDeviceRule>>(), DeprecatedFeatureConfigIssue, 2, 42, issue);
        QCOMPARE(issue->feature(), DeprecatedFeature::TriggerHandlerSettings);
    }
    ...
    void touchpad_devicesNode__addsDeprecatedFeatureConfigIssue()
    {
        ...
        INPUTACTIONS_VERIFY_ADDS_CONFIG_ISSUE_SAVE(node->as<std::vector<InputDeviceRule>>(), DeprecatedFeatureConfigIssue, 3, 16, issue);
...
#include "TestDeviceRuleNodeParser.moc"