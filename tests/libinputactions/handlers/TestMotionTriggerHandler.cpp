    ...
    void handleMotion_swipe__calculatesAnglesCorrectly()
    {
        ...
        EXPECT_CALL(*m_handler,
                    updateTriggers(Contains(Pair(TriggerType::Swipe,
                                                 WhenDynamicCastTo<const SwipeTriggerUpdateEvent
                                                                       *>(Pointee(AllOf(Property(&SwipeTriggerUpdateEvent::angle, expectedAngles),
                                                                                        Property(&SwipeTriggerUpdateEvent::averageAngle, expectedAngles))))))))
            .Times(1);
...
#include "TestMotionTriggerHandler.moc"